...
analysis = pandas.read_csv('datasets/analysis.csv')
df = pandas.read_csv('datasets/cases.csv')
forecast = pandas.read_csv('datasets/forecast.csv')
...
def graph():
    ...
    if plot_type == 'crime-types':
        ...
        df = pandas.read_csv('datasets/analysis.csv')
        ...
        if not year or not state:
            ...
            data = pandas.read_csv('datasets/analysis.csv')
            state = request.form['state']
...
def predictions():
    if request.method == 'POST':
        ...
        all_states = list(set(forecast['State'].to_list()))
        all_states.sort()
